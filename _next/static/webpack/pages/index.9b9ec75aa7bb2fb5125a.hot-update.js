...
})(["max-width:1040px;background:#0F1624;display:grid;grid-template-columns:1fr 1fr;&:first-of-type{margin-left:0;}margin-bottom:80px;scrollbar-width:none;&::-webkit-scrollbar{display:none;}@media ", "{overflow-x:scroll;-webkit-overflow-scrolling:touch;scroll-snap-type:x mandatory;touch-action:pan-x;justify-content:initial;margin-bottom:8px;}"], function (props) {
