...
})(["display:", ";flex-direction:", ";padding:", ";margin:0 auto;padding-top:60px;max-width:1040px;box-sizing:content-box;position:relative;overflow:hidden;grid-template-columns:1fr 1fr;@media ", "{padding:24px 48px 0;flex-direction:column;}@media ", "{padding:", ";margin-top:40px;width:calc(100vw - 32px);flex-direction:column;}"], function (props) {
